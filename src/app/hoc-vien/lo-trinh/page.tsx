...
const COURSE_META: Record<string, { emoji: string; gradient: string; accent: string }> = {
  THINKING_MATH: { emoji: '🧠', gradient: 'from-purple-500 to-indigo-600', accent: '#6366f1' },
  MATH:          { emoji: '📐', gradient: 'from-blue-500 to-indigo-600',   accent: '#3b82f6' },
  TOAN:          { emoji: '📐', gradient: 'from-blue-500 to-indigo-600',   accent: '#3b82f6' },
  ...
  PHYSICS:       { emoji: '⚛️', gradient: 'from-violet-500 to-indigo-700', accent: '#8b5cf6' },
  ...
  CPP:           { emoji: '⚡', gradient: 'from-violet-500 to-purple-700', accent: '#7c3aed' },
