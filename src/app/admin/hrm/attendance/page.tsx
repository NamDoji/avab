    ...
    <div className="min-h-screen pt-20 bg-gray-50">
      ...
      >
        ...
        <div className="container-custom relative">
          ...
          <p className="text-purple-100 text-sm">Check-in / Check-out, báo cáo giờ làm</p>
        </div>
      </div>
      ...
      <div className="container-custom py-16 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 text-sm max-w-md mb-6">
          Phân hệ Chấm công đang được xây dựng. Sẽ tích hợp QR code / fingerprint / geofencing.
        </p>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 text-left max-w-md w-full mb-8">
          ...
          <div className="space-y-3">
            {[
              { label: 'Check-in/out bằng QR code', eta: 'Q3/2025', done: false },
              { label: 'Báo cáo giờ làm theo tháng', eta: 'Q3/2025', done: false },
              { label: 'Tích hợp lịch công tác', eta: 'Q4/2025', done: false },
              { label: 'Geofencing & Mobile app', eta: 'Q4/2025', done: false },
            ].map((item) => (
