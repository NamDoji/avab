    ...
    <div className="min-h-screen pt-20 bg-gray-50">
      ...
      >
        ...
        <div className="container-custom relative">
          ...
          <h1 className="text-3xl font-black mb-1">📊 KPI &amp; OKR</h1>
          <p className="text-purple-100 text-sm">Thiết lập mục tiêu, đánh giá hiệu suất nhân viên</p>
        </div>
      </div>
      ...
      <div className="container-custom py-16 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 text-sm max-w-md mb-6">
          Hệ thống KPI &amp; OKR cho phép thiết lập mục tiêu theo quý, đánh giá 360° và theo dõi tiến độ thực hiện.
        </p>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 text-left max-w-md w-full mb-8">
          ...
          <div className="space-y-3">
            {[
              { label: 'Thiết lập KPI theo bộ phận', eta: 'Q4/2025', done: false },
              { label: 'Đánh giá 360° hàng quý', eta: 'Q4/2025', done: false },
              { label: 'OKR — Objectives & Key Results', eta: 'Q1/2026', done: false },
              { label: 'Dashboard hiệu suất AI', eta: 'Q1/2026', done: false },
            ].map((item) => (
