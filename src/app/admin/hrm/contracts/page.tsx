    ...
    <div className="min-h-screen pt-20 bg-gray-50">
      ...
      <div className="container-custom py-16 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 text-sm max-w-md mb-6">
          Phân hệ Hợp đồng lao động đang được xây dựng. Dự kiến ra mắt cùng phiên bản HRM đầy đủ.
        </p>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 text-left max-w-md w-full mb-8">
          ...
          <div className="space-y-3">
            {[
              { label: 'Tạo & lưu trữ HĐLĐ', eta: 'Q3/2025', done: false },
              { label: 'Gia hạn & cảnh báo hết hạn', eta: 'Q3/2025', done: false },
              { label: 'Ký số điện tử', eta: 'Q4/2025', done: false },
              { label: 'Báo cáo hợp đồng', eta: 'Q4/2025', done: false },
            ].map((item) => (
